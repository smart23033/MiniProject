package example.tacademy.com.miniproject.manager;
...
import example.tacademy.com.miniproject.MyApplication;
...
public class DBManager extends SQLiteOpenHelper{
    ...
    public long addUser(User user) {
        ...
        throw new IllegalArgumentException("already user added");
    }
